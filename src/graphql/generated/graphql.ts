...
export type GetUserQuery = { __typename?: 'Query', me: { __typename?: 'User', id: string, username: string, phoneNumber: string, account: { __typename?: 'Account', id: string, balance: number, transactions?: Array<{ __typename?: 'Transaction', id: string, amount: number, type: TransactionType, description: string, timestamp: string }> | null } } };
